...
export function MarketAnalysis() {
    ...
    const treemap_url = `http://localhost:8080/api/treemap/${feature}`;
    const stacked_bar_price_url = `http://localhost:8080/api/stacked_bar_price/${feature}`;
    const pie_chart_url = `http://localhost:8080/api/pie_company_counts`;
